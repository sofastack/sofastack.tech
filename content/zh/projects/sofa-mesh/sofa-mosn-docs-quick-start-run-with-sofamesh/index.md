...
aliases: "/sofa-mesh/docs/RunWithSOFAMesh"
---
...
我们曾在 [《SOFAMosn Introduction》](../sofa-mosn-readme) 一文中介绍过，SOFAMosn 是一款采用 Golang 开发的 Service Mesh 数据平面代理。而 SOFAMesh 则是基于 Istio
