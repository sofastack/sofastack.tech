...
长远看来，ElasticDL 还将支持各种学习模式，以顺应金融行业对 AI 的多种需求。很多在传统互联网行业可有可无的训练模式，在金融行业都很有广阔的应用场景，比如保障数据安全的同时还能共享数据背后规律的共享智能，或者建立可以进行各种大胆试验的虚拟环境，这些面向未来的需求，在 ElasticDL 的设计之中也有所考虑。
